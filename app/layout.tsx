                ...
                <Card>
                  <CardHeader>
                    <div className="flex flex-row items-start justify-between">
                      ...
                      <a
                        href="https://github.com/jclackett/rate-my-next"
                        target="_blank"
                        rel="noreferrer"
                    ...
                    <CardDescription className="font-mono text-sm">
                      Enter a GitHub repo URL to rate your Next.js repository and compare it to others based on very meaningful
                      metrics. Find some of the largest Next.js apps out there.
                    </CardDescription>
                  </CardHeader>
